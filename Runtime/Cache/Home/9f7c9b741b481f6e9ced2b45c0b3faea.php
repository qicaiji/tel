...
<!--    <li class="text-center"><a href="<?php echo U('index/index');?>">首页</a></li>-->
	...
	<table class="table table-bordered table-hover table-striped">
        ...
        <tbody>
            <?php if(is_array($dlist)): $i = 0; $__LIST__ = $dlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$one): $mod = ($i % 2 );++$i;?><tr>
					<td><?php echo ($one["did"]); ?></td>
                    ...
                    <td>
                        <a href="<?php echo U('edit',array('did'=>$one['did']));?>">编辑</a> | 
                        <a href="<?php echo U('del',array('did'=>$one['did']));?>" onClick="javascript:return del()">删除</a>
                    </td>
